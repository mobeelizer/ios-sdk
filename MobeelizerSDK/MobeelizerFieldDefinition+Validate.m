// 
// MobeelizerFieldDefinition+Validate.m
// 
...
@implementation MobeelizerFieldDefinition (Validate)
...
- (void)validateField:(id)object forErrors:(MobeelizerErrors *)errors {
    ...
    if([object valueForKey:self.name] == nil) {
        return;
    }

    [self validateTypeField:object forErrors:errors];
}
