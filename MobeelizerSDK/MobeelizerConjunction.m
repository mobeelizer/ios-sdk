...
@interface MobeelizerConjunction ()

@property (nonatomic, strong) NSMutableArray *criteria;    

@end

@implementation MobeelizerConjunction
...
- (NSString *)addToQuery:(NSMutableArray *)params {
    ...
    return [NSString stringWithFormat:@"(%@)", [array componentsJoinedByString:@") and ("]];
}
